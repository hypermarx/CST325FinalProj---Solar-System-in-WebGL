...
class WebGLGeometryJSON {
    ...
    render(camera, projectionMatrix, shaderProgram) {
        ...
        if (attributes.hasOwnProperty('vertexSpecularTexcoordsAttribute')) {
            this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.specularTexcoordbuffer);
            this.gl.vertexAttribPointer(
                attributes.vertexSpecularTexcoordsAttribute,
                2,
                this.gl.FLOAT,
                false,
                0,
            ...
            this.gl.enableVertexAttribArray(attributes.vertexSpecularTexcoordsAttribute);
        }
